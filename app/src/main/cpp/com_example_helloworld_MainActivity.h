...
extern "C" {
#endif
#undef com_example_helloworld_MainActivity_PERMISSIONS_REQUEST_CODE
#define com_example_helloworld_MainActivity_PERMISSIONS_REQUEST_CODE 1000L
/*
 * Class:     com_example_helloworld_MainActivity
 * Method:    ConvertRGBtoGray
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_example_helloworld_MainActivity_ConvertRGBtoGray
